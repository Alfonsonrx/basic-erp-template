import type { EventDetailDialogRenderer } from "@dayflow/core";

const CustomAppointmentModal: EventDetailDialogRenderer = ({
  event,
  isOpen,
  onClose,
  onEventUpdate,
  ...
  const accent = "#6366f1";
  // const handleColor = (next: string) => onEventUpdate({ ...event });
